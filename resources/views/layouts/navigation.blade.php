    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="flex items-center gap-3">
                ...
                <!-- Notification Bell -->
                <button
                    class="relative p-2 text-slate-400 hover:text-indigo-600 transition-colors rounded-full hover:bg-slate-50">
                    ...
                    <!-- Red Dot Indicator -->
                    <span
                        class="absolute top-2 right-2 block h-2 w-2 rounded-full bg-rose-500 ring-2 ring-white"></span>
                </button>
                ...
                <div class="hidden sm:flex sm:items-center">
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button
                                class="flex items-center gap-2 pl-3 pr-2 py-1.5 border border-transparent text-sm leading-4 font-medium rounded-full text-slate-500 hover:text-slate-700 hover:bg-slate-50 focus:outline-none transition ease-in-out duration-150">
                                <div
                                ...
                                <div class="hidden md:block text-left">
                                    ...
                                    <div class="text-[10px] text-slate-400">
                                        {{ Auth::user()->role === 'admin' ? 'Administrator' : 'User Biasa' }}</div>
                                </div>
                                <div class="ms-1">
                        ...
                        <x-slot name="content">
                            ...
                            <form method="POST" action="{{ route('logout') }}">
                                ...
                                <x-dropdown-link :href="route('logout')"
                                    ...
                                    class="text-rose-600 hover:text-rose-700 hover:bg-rose-50 flex items-center gap-2">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
